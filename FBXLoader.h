...
{
	double x, y;
	DirectX::XMFLOAT2 ToXMFLOAT2(void)
	{
...
public:
	DirectX::XMFLOAT3 ToXMFLOAT3(void)
	{
...
public:
	DirectX::XMFLOAT4X4 ToXMFLOAT4X4(void)
	{
...
public:
	DirectX::XMFLOAT4 ToXMFLOAT4(float a)
	{
		return DirectX::XMFLOAT4((float)r, (float)g, (float)b, a);
	}
};
...
{
	UpVector UpAxis = UpVector_AxisZ;
	int UpAxisSign = 1;
	int FrontAxis = 1; 
	int FrontAxisSign = 1;
	CoordSystem CoordAxis = CoordSystem_LeftHanded;
	int CoordAxisSign = 1;
